...
/**
 * @decs: CounterFloatingActionButton
 * A [FloatingActionButton] subclass that shows a counter badge on right top corner.
 *
 * @author: 郑少鹏
 * @date: 2019/7/19 13:38
 */
class CounterFloatingActionButton @JvmOverloads constructor(
    ...
    private val animationProperty = object : Property<CounterFloatingActionButton, Float>(Float::class.java, "animation") {
        override fun set(counterFloatingActionButton: CounterFloatingActionButton, value: Float) {
            animationFactor = value
            postInvalidateOnAnimation()
        }

        override fun get(counterFloatingActionButton: CounterFloatingActionButton): Float {
            return 0f
        }
    }
    ...
    private val isAnimating: Boolean get() = animator.isRunning
    ...
    init {
        val styledAttributes = context.theme.obtainStyledAttributes(attrs, R.styleable.CounterFloatingActionButton, 0, 0)
        textPaint.color = styledAttributes.getColor(R.styleable.CounterFloatingActionButton_badgeTextColor, Color.WHITE)
        circlePaint.color = styledAttributes.getColor(R.styleable.CounterFloatingActionButton_badgeBackgroundColor, getDefaultBadgeColor())
        badgePosition = styledAttributes.getInt(R.styleable.CounterFloatingActionButton_badgePosition, RIGHT_TOP_POSITION)
    ...
    private fun startAnimation() {
        ...
        animator = ObjectAnimator.ofObject(this, animationProperty, null, start, end).apply {
