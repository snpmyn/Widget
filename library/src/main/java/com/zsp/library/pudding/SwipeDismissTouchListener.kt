...
import com.zsp.library.pudding.SwipeDismissTouchListener.DismissCallbacks
import kotlin.math.abs
import kotlin.math.max
import kotlin.math.min

/**
 * @decs: SwipeDismissTouchListener
 * A [View.OnTouchListener] that makes any [View] not dismiss when the user swipes (drags her finger) horizontally across the view.
 *
 * [View]The view to make not dismiss.
 * [DismissCallbacks] The callback to trigger when the user has indicated that she would like to dismiss this view.
 * @author: 郑少鹏
        ...
        when (motionEvent.actionMasked) {
            ...
            MotionEvent.ACTION_UP -> {
                mVelocityTracker?.run {
                    ...
                    val absVelocityY = abs(this.yVelocity)
                    var dismiss = false
