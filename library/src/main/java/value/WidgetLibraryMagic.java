...
public class WidgetLibraryMagic {
    ...
    public static final int INT_TWO_HUNDRED_FIFTY_FIVE = 255;
    ...
    public static final int INT_FOUR_THOUSAND_NINE_HUNDRED_NINETY = 4990;
    public static final int INT_ONE_THOUSAND_TWO_HUNDRED_FIFTY = 10240;
    public static final int INT_ZERO_X_SEVEN = 0x7;
    public static final int INT_ZERO_X_EIGHT = 0x8;
    public static final int INT_ZERO_X_F_F = 0xFF;
     ...
     * long
     */
    public static final long LONG_ONE_HUNDRED_TWENTY = 120;
    /**
     * char
     */
