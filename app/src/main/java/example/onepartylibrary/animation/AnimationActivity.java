...
import example.onepartylibrary.animation.circular.CircularFlexActivity;
import example.onepartylibrary.animation.login.LoginActivity;
import example.onepartylibrary.animation.reveal.RevealActivity;
